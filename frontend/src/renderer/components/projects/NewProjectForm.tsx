...
class BaseForm extends React.Component<Props, State> {
  ...
  public render() {
    ...
    return (
      <Form onSubmit={this.createProject} layout="vertical">
        ...
        <Form.Item>
          <Button htmlType="submit" onClick={this.createProject} className="button-green">
            Create Project
          </Button>
        </Form.Item>
      </Form>
  ...
  public createProject = e => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      return this.props.onCreate({ ...values, avatar: this.state.avatar })
    })
  }
}

export const NewProjectForm = Form.create()(BaseForm)
